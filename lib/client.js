...
function WebUISection({ t }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
    ...
    status?.adopted ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: styles.muted, children: translate("adopted") }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 8, margin: "10px 0" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: styles.button, disabled: startDisabled, onClick: () => void run("start"), children: busy ? translate("busy") : translate("start") }),
